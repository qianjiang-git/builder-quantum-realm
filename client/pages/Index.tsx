  ...
  const features = [
    {
      ...
      description:
        "Transform your ideas into stunning designs with our intelligent AI assistant that understands your creative vision.",
    },
    {
      title: "Real-time Collaboration",
      description:
        "Work seamlessly with your team in real-time, share feedback instantly, and iterate together effortlessly.",
    },
    {
      title: "Advanced Precision Tools",
      description:
        "Fine-tune every detail with professional-grade tools that give you complete control over your designs.",
    },
  ];
    ...
    <div className="min-h-screen w-full bg-white font-['Inter',sans-serif]">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-aura-border-light">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a
            href="#features"
            className="text-aura-medium transition-colors hover:text-aura-dark"
          >
            Features
          </a>
          <a
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-aura-medium mb-8 max-w-2xl mx-auto">
              The AI design tool that understands your creative vision and helps
              you bring it to life with unprecedented speed and accuracy.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path
                    d="M6.25 4.375L15 10L6.25 15.625V4.375Z"
                    fill="currentColor"
                  ></path>
                </svg>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-aura-medium max-w-2xl mx-auto">
              Experience the perfect balance of creative freedom and technical
              precision in one powerful platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-aura-medium mb-8 leading-relaxed">
                ...
                AI-powered platform understands your creative intent and helps
                you express it with tools that feel natural and intuitive.
              </p>
                ...
                {features.map((feature, index) => (
                  <div
                    ...
                    className={`flex items-start gap-4 p-4 rounded-xl transition-all cursor-pointer ${
                      activeFeature === index
                        ? "bg-white border border-aura-border"
                        : "bg-transparent"
                    }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-aura-dark font-semibold text-lg">
                  Aura
                </span>
              </div>
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-aura-bg rounded-lg flex items-center justify-center transition-colors hover:bg-aura-border"
                >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-90vh overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-aura-border">
              <h3 className="text-lg font-semibold text-aura-dark">
                Aura Demo
              </h3>
              <button
